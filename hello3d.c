/*
   Exemplo de uma primeira aplicação 3D usando OpenGL e IUP
   Professor: Rafael Rieder
   UPF - Universidade de Passo Fundo
   
   Objetivo: Cria um janela de diálogo com um canvas e
   desenha em OpenGL rotacionando um cubo.
   Créditos: Marcelo Gattass, 2009. Tecgraf PUC-Rio.
   Fonte: http://webserver2.tecgraf.puc-rio.br/iup/
*/
